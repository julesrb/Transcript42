...
REDIRECT_URI = os.getenv("OAUTH_REDIRECT_URI", "http://68.183.66.13/oauth_redirect")
...
def authorization_Request():
	return RedirectResponse(generate_authorization_request_url())
